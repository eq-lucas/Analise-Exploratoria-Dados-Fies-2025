...
path = '../../../../planilhas/GERAL DF_funil 11 etapas.csv'
...
output_dir = '../GRAFICOS/FUNIL 11 ETAPAS REGIAO GERAL'
...
print("\n--- INICIANDO GERAÇÃO DOS GRÁFICOS POR REGIÃO (11 ETAPAS) ---")

for regiao in regioes:
    df_filtrado = df[df['Regiao'] == regiao]
    
    if not df_filtrado.empty:
        titulo_grafico = f'Funil Geral do FIES com 11 Etapas (Região {regiao})'
        nome_arquivo = f'funil_geral_11_etapas_{regiao}'
...
print("\n--- INICIANDO GERAÇÃO DO GRÁFICO NACIONAL (11 ETAPAS) ---")

titulo_nacional = 'Funil Nacional do FIES com 11 Etapas (Todas as Regiões)'
nome_arquivo_nacional = 'funil_nacional_11_etapas_total'
plotar_e_salvar_funil_barras(df, titulo_nacional, nome_arquivo_nacional, output_dir, COLUNAS_FUNIL_11_ETAPAS)


print("\n\n--- PROCESSO CONCLUÍDO! ---")
print(f"Todos os gráficos gerais de 11 etapas foram salvos na pasta '{output_dir}'.")
