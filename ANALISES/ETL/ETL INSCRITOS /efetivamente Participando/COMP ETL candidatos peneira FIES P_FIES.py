...
caminho_inscricoes = '../../../../planilhas ETL/GERAL ETL candidatos peneira FIES P_FIES.csv'
...
df_organizado.to_csv('../../../../planilhas ETL/COMP ETL candidatos peneira FIES P_FIES.csv',index=False)
