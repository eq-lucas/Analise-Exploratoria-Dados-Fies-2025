# ate posso fazer um for para cada ano ir fazer seus merge com

#um dataset microdados cadastro cursos com CO CURSO e o nome ( pegando so estas 2 coluans)

#mas vai ficar com Nan ainda, sendo ~3% de alunos aleatoriamente com nan's

# e o gemini fazendo o manualmente ,foi 399 cursos, ficava dando erro toda hora pois tem mts com nomes escritos esrrados
...
for ano in anos:
    ...
    for semestre in semestres:
        ...
        df_temp['codigo_curso_inscricao'], 
        errors='coerce'
        )
        ...
        path_salvar= '../../../planilhas/limpo/modulo_1/inscricao_coluna_CINE/'
        nome_salvar = f'fies_{semestre}_inscricao_{ano}_limpo_cine.csv'
