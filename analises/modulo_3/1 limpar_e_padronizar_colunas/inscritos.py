...
path= '../../../planilhas/limpo/modulo_2/inscritos_coluna_filtro_renda/ajustado_fies_pfies_inscritos.csv'

mapa_nomes_curto = {
    # Chaves de processo
    'ano_processo_seletivo_inscricao': 'ano_processo',
    'semestre_processo_seletivo_inscricao': 'semestre_processo',
